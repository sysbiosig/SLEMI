...
Additional examples of using package with some background on information theory is given in [`testing_procedures/SLEMI_testing.pdf`](https://github.com/sysbiosig/SLEMI/blob/master/testing_procedures/SLEMI_testing.pdf) and implemented in script [`testing_procedures/testing_procedures.R`](https://github.com/sysbiosig/SLEMI/blob/master/testing_procedures/testing_procedures.R). Codes used in publication are accessible from [`testing_procedures/paper_MP.R`](https://github.com/sysbiosig/SLEMI/blob/master/testing_procedures/paper_MP.R) and [`testing_procedures/paper_SI.R`](https://github.com/sysbiosig/SLEMI/blob/master/testing_procedures/paper_SI.R) respectively.
...
SLEMI is released under the GNU licence and is freely available. A comprehensive documentation is available on [github.io](https://github.io/) and in directory [`docs/SLEMI_documentation.pdf`](https://github.com/sysbiosig/SLEMI/blob/master/docs/SLEMI_documentation.pdf).
